          ...
          >
            ...
            <Button onClick={() => setCreateAthleteModalOpen(true)}>
              <>
                <PersonAdd />
                {t(
                  "components.athleteDatagrid.table.toolbar.createAthlete.label",
                )}
              </>
            </Button>
            <Button onClick={() => setAddAthleteRequestModalOpen(true)}>
              <>
                <PersonSearch />
                {t("components.athleteDatagrid.table.toolbar.addAthlete.label")}
              </>
            </Button>
          </Box>
        ) : null}
